<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="HomeoClinic.Login" %>
...
<div class="Login card" style="border: 2px solid  #1E90FF;">
    ...
    <div class="card-body pt-0">
      ...
      <div class="font text-center" >
        ...
        <!-- Email -->
        <div class="md-form">
          <asp:Label ID="Label1" runat="server" class="Log-lab" Text="Email OR User ID"></asp:Label>          
          <asp:TextBox ID="TextBox1" runat="server" type="email" class="form-control" placeholder="Your Email Address"></asp:TextBox>               
        </div>
  
        <!-- Password -->
        <div class="md-form">
          <asp:Label ID="Label2" runat="server" class="Log-lab" Text="Password" ></asp:Label>
          <asp:TextBox ID="TextBox2" runat="server" type="password" class="form-control" placeholder="Your Password"></asp:TextBox>                 
        </div>
  
        <div class="d-flex justify-content-around">          
          <div>
            <!-- Forgot password -->
            <a href="Password_Recovery.aspx">Forgot password?</a>
          </div>
        </div>            
        ...
        <asp:Button ID="Button1" runat="server" type="submit" Text="Login" OnClick="Button1_Click" style="width: 150px;" name="sign in" class="btn btn-primary"/>        
      </div>
      <!-- Form -->
