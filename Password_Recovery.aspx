<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Password_Recovery.aspx.cs" Inherits="HomeoClinic.Password_Recovery" %>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white py-3 shadow-sm">
        <div class="container">
          ...
          <div id="navbarContent" class="collapse navbar-collapse">
            <a href="Login.aspx" class="btn btn-primary">Login/Regiser</a>
...
<div class="Login card" style="border: 2px solid  #1E90FF;">
    ...
    <h5 class="card-head info-color white-text text-center py-4" style="background-color:#1E90FF">
      <strong style="color:white">Password Recovery</strong>
    </h5>
    ...
    <div class="card-body pt-0">
      ...
      <div class="text-center">
        ...
        <!-- Email -->
        <div class="md-form">
          <label class="Log-lab">E-mail</label>
          <asp:TextBox ID="TextBox1" runat="server" type="email" class="form-control" placeholder="Your Email Address"></asp:TextBox>
        </div>    
        <br />     
          <asp:Button ID="Button1" runat="server" Text="Recover Password" OnClick="Button1_Click" type="submit" value="Recover Password" style="width: 150px;" name="Recover Password" class="btn btn-primary"/><br />
          <label style="font-weight:bold">Your Password will be Sent to Your email</label>
      </div>
      <!-- Form -->
  ...
  <!-- Material form login -->
      <!-- Footer -->
<!-- Footer -->
<footer class="page-footer font-small mdb-color lighten-3 pt-4 center-foot" style="background-color:#87CEEB;">
