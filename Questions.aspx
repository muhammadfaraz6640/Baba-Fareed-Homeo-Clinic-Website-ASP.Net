<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Questions.aspx.cs" Inherits="HomeoClinic.Questions" %>
...
<div class="Login card" style="border: 2px solid  #1E90FF;">
    ...
    <h5 class="card-head info-color white-text text-center py-4" style="background-color:#1E90FF">
      <strong style="color:white">Ask Doctor</strong>
    </h5>
    ...
    <div class="card-body pt-0">
      ...
      <div class="text-center" style="color: black;">
        ...
        <!-- Email -->
        <div class="md-form">
          <label class="Log-lab" >Question</label> 
          <asp:TextBox ID="TextBox1" runat="server" TextMode="MultiLine" Style="margin-left: -27px;width: 200px; height: 170px; padding-bottom:10px;" cols="22" rows="15" placeholder="Write Question...Answer Will Be given by Email"></asp:TextBox> 
        </div>      
        <br />
        <asp:Button ID="Button1" runat="server" Text="Ask" OnClick="Button1_Click" type="submit" value="Ask" style="width: 150px;" name="sign in" class="btn btn-primary"/>        
      </div>
      <!-- Form -->  
    </div>
